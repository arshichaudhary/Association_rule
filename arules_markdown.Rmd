...
###better to save data to file and read it back as a transaction
```{r}
...
###try support of 0.1 and confidence of 0.8 - default values (discovers only 6 rules in our dataset)
##need to reduce support, say 0.05
...
##instead of using the rules that have been discovered in part 3.1, you cab decide which items you want to appear either on the lhs (i.e., targeting the lhs) or rhs (i.e., targeting the rhs)
